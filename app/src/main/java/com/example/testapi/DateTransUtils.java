...
public class DateTransUtils {
    ...
    public static long getZeroClockTimestamp(long time){
        ...
        Log.i("DateTransUtils"," DateTransUtils-getZeroClockTimestamp()  获取当日00:00:00的时间戳,东八区则为早上八点 :" + currentStamp);
        return currentStamp;
    }
    ...
    public static String getDateString(int dayNumber){
        ...
        Log.i("DateTransUtils"," DateTransUtils-getDateString()  获取查询的日期 :" + dateFormat.format(time));
